...
class AnimalStorageTest {
    ...
    AnimalCollection actualAnimals;
    Person person1 = new Person(12, Sex.WOMAN, "Маша");
    Person person2 = new Person(21, Sex.WOMAN, "Валя");
    Person person3 = new Person(12, Sex.MAN, "Миша");
    Person person4 = new Person(21, Sex.MAN, "Ваня");

    @BeforeEach
    void setUp() throws Exception {
        actualAnimals = new AnimalStorage();
